...
namespace mywebapp.Areas.Admin.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public IActionResult OrderDatails(int id)
        {
        ...
        [HttpPost]
        public IActionResult OrderDatails(OrderVM vm)
        {
            ...
            return RedirectToAction("OrderDeatalis","Order",new { id = vm.OrderHeader.Id });
